...
// Cada gasto cuenta en un solo sitio. Si su concepto contiene el nombre
// de un gasto fijo, es fijo; si no, es variable y va a su categoría (la
// elegida al apuntarlo o, si no tiene, la que encaje por el texto) o a
// "Otros" (índice -1).
function clasificarGasto(m, gastosFijos, categorias) {
...
function nombreCategoria(m, gastosFijos, categorias) {
  ...
  return indice !== -1 ? categorias[indice].concepto : "Otros";
}

// Resumen del mes con importes reales.
